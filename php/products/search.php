...
FROM products p LEFT OUTER JOIN pro_imgs g ON p.pro_id =g.pro_id AND g.is_default=1  , sub_cates s  WHERE s.subcat_id=p.subcat_id AND pro_name LIKE '%$val%' $sub_query ";
$data = getArray($sql);
